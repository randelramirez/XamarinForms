...
namespace XamarinForms
{
    public class VerticalOptionsDemoPage : ContentPage
    {
        public VerticalOptionsDemoPage()
        {
            ...
            // becauase the default VerticalTextAlignment is start
            // just wanted to center the text of the last lable
            //(stackLayout.Children.Last() as Label).VerticalTextAlignment = TextAlignment.Center;
            //foreach (var label in stackLayout.Children)
            //{
            //    (label as Label).VerticalTextAlignment = TextAlignment.Center;
            //}
